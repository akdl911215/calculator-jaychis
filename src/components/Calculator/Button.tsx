...
// ① Variant 타입만 따로 선언
type Variant = "primary" | "operator" | "digit" | "equal"
...
export default function Button({
  ...
  const base =
    "font-serif py-4 rounded-md shadow-md border border-amber-900 transition-colors flex items-center justify-center"
